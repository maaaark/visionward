 ...
 * Generated for Laravel 4.2.17 on 2015-05-19.
 *
...
namespace {
    ...
    class Croppa extends \Bkwld\Croppa\Facade{
        ...
        public static function reset($url){
            return \Bkwld\Croppa\Croppa::reset($url);
        }
         ...
         * @static 
         */
        public static function findFilesToDelete($url, $delete_original = true){
            return \Bkwld\Croppa\Croppa::findFilesToDelete($url, $delete_original);
        }
         ...
         * @static 
         */
        public static function directoryPattern(){
            return \Bkwld\Croppa\Croppa::directoryPattern();
        }
         ...
         * @static 
         */
        public static function checkForFile($path){
            return \Bkwld\Croppa\Croppa::checkForFile($path);
        }
         ...
         * @static 
         */
        public static function checkForFileByPath($path){
            return \Bkwld\Croppa\Croppa::checkForFileByPath($path);
        }
         ...
         * @static 
         */
        public static function tooManyCrops($src){
            return \Bkwld\Croppa\Croppa::tooManyCrops($src);
        }
         ...
         * @static 
         */
        public static function makeOptions($option_params){
            return \Bkwld\Croppa\Croppa::makeOptions($option_params);
        }
         ...
         * offset pixels
         *
         * @param \Bkwld\Croppa\PhpThumb $thumb
         * @param array $options Cropping instructions as pixels
         * @return void 
         * @static 
         */
        public static function trim($thumb, $options){
            \Bkwld\Croppa\Croppa::trim($thumb, $options);
        }
         ...
         * @static 
         */
        public static function trimPerc($thumb, $options){
            \Bkwld\Croppa\Croppa::trimPerc($thumb, $options);
        }
