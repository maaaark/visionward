...
<div class="row comment_bottom">
    <div class="col-md-2 center">
        ...
        <a href="http://summoner.flashignite.com/{{ Auth::user()->summoner->region }}/{{ Auth::user()->summoner->name }}"><img width="50" src="http://ddragon.leagueoflegends.com/cdn/{{ $patchversion }}/img/profileicon/{{ Auth::user()->summoner->profileIconId }}.png" class="img-circle" alt="{{ Auth::user()->summoner->name }}" /></a>
        <div class="badge"><a href="/users/{{ $comment->user->username }}">Level {{ $comment->user->level }}</a></div><br/>
