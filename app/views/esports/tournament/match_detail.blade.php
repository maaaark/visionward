...
@section('content')
    ...
    @if(isset($team1) AND isset($team2) AND $team1 AND $team2)
        ...
        @endif
    @else
        <div style="text-align: center;font-size: 28px;padding-top: 40px;padding-bottom: 55px;">
            Es ist noch nicht bekannt, welche Teams dieses Match spielen werden.
            <div style="font-size: 20px;">Schaue sp&auml;ter noch einmal hier vorbei.</div>
        </div>
	@endif
@stop