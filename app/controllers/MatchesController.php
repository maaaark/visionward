...
class MatchesController extends \BaseController {
	...
	public function index()
	{
        ...
        $others = Match::orderBy("game_date", "DESC")->where("parent_game", "=", "0")->where("league_id", "=",40)->orWhere('league_id', 41)-> orWhere("parent_game", "=", "0")->orWhere('league_id', 43)-> orWhere("parent_game", "=", "0")->paginate(12);
